                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($dataQuery)) : ?>
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2"><?= "Rp " . number_format($row['gaji'], 2, ',', '.'); ?></td>
                            <?php if ($is_admin): ?>
                                <td class="px-4 py-2">
                                    <a href="edit.php?id=<?= $row['id'] ?>" class="text-yellow-600 dark:text-yellow-600 hover:underline text-sm mr-2">Edit</a>
